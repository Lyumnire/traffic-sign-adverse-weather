"""
Traffic Sign Classification under Adverse Weather - Inference Script (v3)
========================================================================
...
v3 Changes:
- Auto-install timm (fixes ConvNeXt V2 architecture mismatch)
- Architecture validation (catch silent weight loading failures)
- Removed locally-tuned parameters (temp, weights) - not transferable
- Simple equal-weight ensemble (safe default, no local data dependency)
"""
...
def predict(X):
    ...
    # Ensemble: equal-weight soft voting across all available models
